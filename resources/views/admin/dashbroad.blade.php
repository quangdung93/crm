...
<div class="page-body dashbroad">
            ...
            <div class="bg-green-400 panel widget center bgimage" style="border-radius:6px; position:relative; overflow:hidden; background-image: linear-gradient(to right, #6a11cb 0%, #2575fc 100%);">
                <div style="width:100%; height:40px; display:flex; position:relative; z-index:20; justify-content: start; color:#fff;">
                    ...
                    <div class="relative" style="margin-left:14px; text-align:left;">
                        ...
                        <p style="display:block; color:#dce9fe; text-align:left; line-height:14px; margin:0px;font-size:12px">356 sản phẩm</p>
                    </div>
                    <a href="https://wave.test/admin/do" style="cursor:pointer; flex-shrink:0; justify-self:end; margin-left:auto; background:#fff; color:#4801FF; font-weight:500; padding:10px 20px; border-radius:4px;">
                        Xem ngay
                    </a>
                </div>
                <img src="/storage//settings/April2021/digital-ocean.png" style="width:130px; z-index:10; height:auto; top:10px; right:140px; opacity:30%; position:absolute;">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="bg-green-400 panel widget center bgimage" style="border-radius:6px; position:relative; overflow:hidden; background-image: linear-gradient(to right, #b8cbb8 0%, #b8cbb8 0%, #b465da 0%, #cf6cc9 33%, #ee609c 66%, #ee609c 100%);">
                <div style="width:100%; height:40px; display:flex; position:relative; z-index:20; justify-content: start; color:#fff;">
                    ...
                    <div class="relative" style="margin-left:14px; text-align:left;">
                        ...
                        <p style="display:block; text-align:left; line-height:14px; margin:0px;font-size:12px">65 đơn hàng</p>
                    </div>
                ...
                <img src="/storage//settings/April2021/popcorn-soda-icon.png" style="width:80px; z-index:10; height:auto; bottom:-30px; right:5px; position:absolute;">
            </div>
        </div>
        <div class="col-sm-4">
            <div class="bg-green-400 panel widget center bgimage" style="border-radius:6px; position:relative; overflow:hidden; background-image: url('/storage//settings/April2021/tails-bg.png'); background-size:cover;">
                <div style="width:100%; height:40px; display:flex; position:relative; z-index:20; justify-content: start; color:#fff;">
                    <img src="/storage//settings/April2021/tails-icon.png" class="hidden-md" style="width:40px; height:40px;">
                    <div class="relative" style="margin-left:14px; text-align:left;">
                        ...
                        <p style="display:block; text-align:left; color:#dce9fe; line-height:14px; margin:0px;font-size:12px">89 bài viết</p>
                    </div>
    ...
    <div class="row mt-4">
        ...
        <div class="analytics-container">
            @php
                $google_analytics_client_id = setting("google_analytics_client_id");
            @endphp
            ...
            @else
                <p style="border-radius:4px; padding:20px; background:#fff; margin:0; color:#999; text-align:center;">
                    To view analytics you'll need to get a google analytics client id and add it to your settings for the key <span class="code">google_analytics_client_id</span>
            ...
            <div class="Dashboard Dashboard--full" id="analytics-dashboard">
                <header class="Dashboard-header">
                    <ul class="FlexGrid">
                        <li class="FlexGrid-item">
                            <div class="Titles">
                                <h1 class="Titles-main" id="view-name">select_view</h1>
                                <div class="Titles-sub">various_visualizations</div>
                            </div>
                        </li>
                ...
                <ul class="FlexGrid FlexGrid--halves">
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">this_vs_last_week</h1>
                                <div class="Titles-sub">by_users</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">this_vs_last_year</h1>
                                <div class="Titles-sub">by_users</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">top_browsers</h1>
                                <div class="Titles-sub">by_pageview</div>
                            </header>
                    ...
                    <li class="FlexGrid-item">
                        <div class="Chartjs">
                            <header class="Titles">
                                <h1 class="Titles-main">top_countries</h1>
                                <div class="Titles-sub">by_sessions</div>
                            </header>
        ...
        <script>
            ...
            gapi.analytics.ready(function () {
                ...
                var viewSelector = new gapi.analytics.ext.ViewSelector2({
                    ...
                    propertyId: '{{ setting("google_analytics_tracking_id")  }}'
                }).execute();
